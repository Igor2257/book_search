...
@JsonKey(name: 'theme') bool get isLight;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppSettingsDto&&(identical(other.isLight, isLight) || other.isLight == isLight));
}
...
@override
String toString() {
  return 'AppSettingsDto(isLight: $isLight)';
}
...
@useResult
$Res call({
@JsonKey(name: 'theme') bool isLight
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'theme')  bool isLight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettingsDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'theme')  bool isLight)  $default,) {final _that = this;
switch (_that) {
case _AppSettingsDto():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'theme')  bool isLight)?  $default,) {final _that = this;
switch (_that) {
case _AppSettingsDto() when $default != null:
return $default(_that.isLight);case _:
  return null;
...
class _AppSettingsDto implements AppSettingsDto {
   _AppSettingsDto({@JsonKey(name: 'theme') required this.isLight});
  factory _AppSettingsDto.fromJson(Map<String, dynamic> json) => _$AppSettingsDtoFromJson(json);

@override@JsonKey(name: 'theme') final  bool isLight;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppSettingsDto&&(identical(other.isLight, isLight) || other.isLight == isLight));
}
